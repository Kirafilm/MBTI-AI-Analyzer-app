    ...
    return (
      <ScreenContainer className="items-center justify-center p-6">
        <View className="gap-4 items-center">
          ...
          <Text className="text-sm text-muted text-center">{t("historyEmptyDescription")}</Text>
          <Pressable
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        <View className="gap-4">
          <View className="gap-2">
            <Text className="text-2xl font-bold text-foreground">{t("historyScreenTitle")}</Text>
            <Text className="text-sm text-muted">
              {t("totalQuizCount").replace("{count}", String(results.length))}
            </Text>
          </View>
                    ...
                    <View className="flex-row items-center justify-between">
                      <View className="flex-1">
                        ...
                        <Text className="text-xs text-muted mt-1">
                          {new Date(result.createdAt).toLocaleString(dateLocale, {
                            year: "numeric",
                            month: "short",
                            day: "numeric",
                            hour: "2-digit",
                    ...
                    <View className="flex-row gap-2 pt-2">
                      ...
                      >
                        <View className="p-2 bg-primary/20 rounded items-center">
                          <Text className="text-xs font-semibold text-primary">{t("viewDetails")}</Text>
                        </View>
                      </Pressable>
                      <Pressable
