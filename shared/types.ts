...
import type { AnalysisLocale } from "./i18n";
...
export interface PersonalityAnalysis {
  resultId: string;
  mbtiType: MBTIType;
  /** Output language for cached AI text; legacy entries omit this and are treated as zh-HK. */
